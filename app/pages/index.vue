...
.home-page__signature {
  ...
  --lo-signature-width: 7.7rem;
  --lo-signature-height: 3.3rem;
  --lo-signature-stroke-width: 3;
}
...
@media (max-width: 720px) {
  ...
  .home-page__signature {
    --lo-signature-width: 5.9rem;
    --lo-signature-height: 2.55rem;
    --lo-signature-stroke-width: 2.6;
  }
}
